...
class _DetailsState extends State<Details> with SingleTickerProviderStateMixin {
  bool isWished = false;
  bool isLiked = false;
  static Future<List<Review>> getReviews(int appId) async{

    final response = await http.get(Uri.parse('https://store.steampowered.com/appreviews/$appId?json=1'));
                    ...
                    child: TabBarView(
                      children: [
                        ...
                        Container(
                          color : const Color(0xFF1A2025),
                          child: FutureBuilder(
                            future: getReviews(widget.game.id),
